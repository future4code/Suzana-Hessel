...
>>> CALLBACK : As funções que são passadas como parâmetro para
outras funções são chamadas de callback
-Callback significa "ligar de volta"/"retribuir"
-Elas recebem este nome porque são usadas no fim
da função principal ou depois de uma etapa
importante dela. 
-Podemos simplificar e passar a arrow function
diretamente como parâmetro, sem criar variáveis.
...
**Exercícios de interpretação de código**
    ...
    1.  Leia o código abaixo
        ...
        Vai ser impresso no console os nomes, apelidos e a quantidade 
        de indices do array, ou seja, o mesmo tamanho do array original.
    ...
    2. Leia o código abaixo
        ...
        Nesse caso, vai ser impresso no console apenas os nomes 
        dos usuários que estão contidos no parâmetro item.
    ...
    3. Leia o código abaixo
        ...
        Nesse caso, foi utilizado o filter, logo vai retornar
        um novo array com tamanho menor que o array original, pois
        foi filtrado o apelido "Chijo", ou seja, retirado do array.
        Então, vai ser impresso no console, apenas os índices 0 e 1.
*/
...
// const novoArrayPetsA = pets.map((item, index, array) => {
//     return item.nome
// })

// console.log(novoArrayPetsA)
...
// const novoArrayNomesProdutos = produtos.map((item, index, array) => {
//     return item.nome 
// })
...
//     { nome: "Sabão em Pó Ypê", categoria: "Limpeza", preco: 10.80 }
//     ]
// const novoArrayNomesPrecos = produtos.map((item, index, array) => {
//     return "nome: " + item.nome + "," + " preco: " + item.preco * 0.95

// })

// console.log(novoArrayNomesPrecos)
